...
main_key = 'EPRWceZgON4uf23iAyhkagccbFGx5GjR' 
main_secret = '8eMV5DqHMqeoTuJ5wotYjbnjGMMejrBV' 

sub_key = 'Twe9rz761sLriCdymvTJx3XY3Lgo4eOo' 
sub_secret = 'Fa8qrleF8STRMLNHjgQcyHCRFubwHgb3'
...
class Trading(Public):
    ...
    def user_orders(self,offset=0,limit=1,descending=True,base='btc',quote='usd'):
        """
        Returns descending list of transactions. Every transaction (dictionary)
        contains::
        ...
        url = self._construct_url("user_orders/", base, quote)
        return self._post(url, data=data, return_json=True, version=2)
